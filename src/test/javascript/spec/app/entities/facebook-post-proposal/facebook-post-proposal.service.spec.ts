...
describe('Service Tests', () => {
    ...
    describe('FacebookPostProposal Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FacebookPostProposalService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/facebook-post-proposals/' + 123);
            });
            it('should return FacebookPostProposal', () => {

                let entity: FacebookPostProposal;
                service.find(123).subscribe((_entity: FacebookPostProposal) => {
                    entity = _entity;
                });
