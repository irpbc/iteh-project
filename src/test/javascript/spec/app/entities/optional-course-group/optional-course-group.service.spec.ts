...
describe('Service Tests', () => {
    ...
    describe('OptionalCourseGroup Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OptionalCourseGroupService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/optional-course-groups/' + 123);
            });
            it('should return OptionalCourseGroup', () => {

                let entity: OptionalCourseGroup;
                service.find(123).subscribe((_entity: OptionalCourseGroup) => {
                    entity = _entity;
                });
