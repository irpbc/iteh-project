...
describe('Service Tests', () => {
    ...
    describe('SchoolYearEnrollment Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SchoolYearEnrollmentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/school-year-enrollments/' + 123);
            });
            it('should return SchoolYearEnrollment', () => {

                let entity: SchoolYearEnrollment;
                service.find(123).subscribe((_entity: SchoolYearEnrollment) => {
                    entity = _entity;
                });
