...
describe('Service Tests', () => {
    ...
    describe('SchoolYear Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SchoolYearService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/school-years/' + 123);
            });
            it('should return SchoolYear', () => {

                let entity: SchoolYear;
                service.find(123).subscribe((_entity: SchoolYear) => {
                    entity = _entity;
                });
