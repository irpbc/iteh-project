...
describe('Service Tests', () => {
    ...
    describe('Commitment Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CommitmentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/commitments/' + 123);
            });
            it('should return Commitment', () => {

                let entity: Commitment;
                service.find(123).subscribe((_entity: Commitment) => {
                    entity = _entity;
                });
