...
describe('Service Tests', () => {
    ...
    describe('CourseEnrollment Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CourseEnrollmentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/course-enrollments/' + 123);
            });
            it('should return CourseEnrollment', () => {

                let entity: CourseEnrollment;
                service.find(123).subscribe((_entity: CourseEnrollment) => {
                    entity = _entity;
                });
