...
describe('Service Tests', () => {
    ...
    describe('Lecturer Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LecturerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/lecturers/' + 123);
            });
            it('should return Lecturer', () => {

                let entity: Lecturer;
                service.find(123).subscribe((_entity: Lecturer) => {
                    entity = _entity;
                });
