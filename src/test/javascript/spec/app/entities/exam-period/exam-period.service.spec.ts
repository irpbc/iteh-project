...
describe('Service Tests', () => {
    ...
    describe('ExamPeriod Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ExamPeriodService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/exam-periods/' + 123);
            });
            it('should return ExamPeriod', () => {

                let entity: ExamPeriod;
                service.find(123).subscribe((_entity: ExamPeriod) => {
                    entity = _entity;
                });
