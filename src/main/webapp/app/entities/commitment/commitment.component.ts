...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/commitment'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Commitment) {
        return item.id;
    }
    registerChangeInCommitments() {
        this.eventSubscriber = this.eventManager.subscribe('commitmentListModification', (response) => this.loadAll());
    }
